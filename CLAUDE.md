# CLAUDE.md — Green CI, Stale Deploy

## Project Classification

- **Type:** factory-output
- **Name:** green-ci-stale-deploy
- **Title:** Green CI, Stale Deploy
...
- Do not create files outside `/Users/hekton/Development/hekton/factory-output/green-ci-stale-deploy` without confirmation
